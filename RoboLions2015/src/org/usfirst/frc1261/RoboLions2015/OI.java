...
public class OI {
    ...
    public OI() {
        ...
        driverY.whenPressed(new AutoRaiseLift());
        ...
        driverB.whileHeld(new ManualRaiseLift());
        driverA = new JoystickButton(driverJoystick, 1);
        driverA.whileHeld(new ManualLowerLift());
        ...
        SmartDashboard.putData("AutoLeftTurn90", new AutoGyroLeftTurn(94));

        SmartDashboard.putData("AutoRightTurn90", new AutoGyroRightTurn(86));


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        SmartDashboard.putNumber("autoGyroDriveForwardDistance", -10);
        SmartDashboard.putData("AutoGyroDriveForward", new AutoGyroDriveForward(SmartDashboard.getNumber("autoGyroDriveForwardDistance")));
    }
