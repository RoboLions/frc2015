...
public class OI {
    ...
    public JoystickButton manipLeftTrigger;
    public JoystickButton manipRightTrigger;
    ...
    public OI() {
        ...
        manipRightTrigger = new JoystickButton(manipulatorJoystick, 14);
        manipRightTrigger.whileHeld(new PistonOut());
        manipLeftTrigger = new JoystickButton(manipulatorJoystick, 13);
        manipLeftTrigger.whileHeld(new PistonIn());
        ...
        manipLeftBumper.whileHeld(new ManualRaiseLift());
        manipRightBumper = new JoystickButton(manipulatorJoystick, 6);
        manipRightBumper.whileHeld(new ManualLowerLift());
        ...
        driverB.whileHeld(new DummyCommand());
        driverA = new JoystickButton(driverJoystick, 1);
        driverA.whileHeld(new DummyCommand());
