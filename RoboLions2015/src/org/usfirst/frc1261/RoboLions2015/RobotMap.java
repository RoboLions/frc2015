...
public class RobotMap {
    ...
    public static void init() {
        ...
        liftSystemLiftEncoder = new Encoder(6, 7, false, EncodingType.k4X);
        ...
        liftSystemliftMotor = new TalonSRX(4);
        LiveWindow.addActuator("LiftSystem", "liftMotor", (TalonSRX) liftSystemliftMotor);
        
        liftSystemupperLimit = new DigitalInput(8);
        LiveWindow.addSensor("LiftSystem", "upperLimit", liftSystemupperLimit);
        
        liftSystemlowerLimit = new DigitalInput(9);
