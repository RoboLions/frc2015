 ...
 *
 */
public class BringLiftUp extends Command {
    ...
    protected boolean isFinished() {
    	return Robot.liftSystem.hitUpperLimit();
    }

    // Called once after isFinished returns true
    protected void end() {
    	Robot.liftSystem.stopLift();
    	Robot.liftSystem.calibrateLiftHeight(LiftSystem.CALIBRATION_LIFT_ENCODER_MAX);
    }
