...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //autonomousCommand = new AutoGyroDriveForward(7);
        autonomousCommand = new AutoLeftTurn90();
    ...
    public void autonomousPeriodic() {
    	SmartDashboard.putNumber("Drive Auto Encoder: ", driveTrain.distanceTraveled());
    ...
    public void teleopPeriodic() {
        ...
        SmartDashboard.putNumber("Left Encoder: ", driveTrain.distanceTraveled());
        try {
